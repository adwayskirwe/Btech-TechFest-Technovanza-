...
<meta name="description" content="VJTI's annual and Maharashtra's largest techno-management festival">
<meta name="keywords" content="Technovanza,Techno,Management,Techfest,december,event,festival,VJTI,Pratibimb,Robowars,VRC,Mumbai,Maharashtra,Enthusia,">
<meta name="author" content="Web & Creatives,Technovanza">

<link rel="shortcut icon" href="images/autobots.jpg">

<title>Autobots|Technovanza</title>
      <style>
  ...
  <!--CARDS BEGIN HERE-->
    <div class="row">
        <div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              <div class="imgWrap">
              <img class="img" src="images/web/Robowars.jpg" >
            ...
            <div class="card-action">
              <div class="se"><a href="robowars.php" style="color:black">READ MORE</a></div>
            </div>
          </div>
        </div>
         ...
         <div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              <img class="img" src="images/web/VRC.jpg">
            ...
            <div class="card-action">
              <div class="se"><a href="vrc.php" style="color:black">READ MORE</a></div>
            </div>
          </div>
        </div>
         ...
         <div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              <img class="img" src="images/web/Maze.jpg">
              <span class="card-title"><div class="re">ROBOMAZE</div></span>
            </div>
            <div class="card-content hide">
              <p>I am a very simple card. I am good at containing small bits of information.
              I am convenient because I require little markup to use effectively.</p>
            ...
            <div class="card-action">
              <div class="se"><a href="robomaze.php" style="color:black">READ MORE</a></div>
            </div>
          </div>
        </div>
        ...
        <div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              <img class="img" src="images/web/Robosocer.jpg">
              <span class="card-title"><div class="re">ROBOSOCCER</div></span>
            </div>
            <div class="card-content hide">
              <p>I am a very simple card. I am good at containing small bits of information.
              I am convenient because I require little markup to use effectively.</p>
            ...
            <div class="card-action">
              <div class="se"><a href="robosoccer.php" style="color:black">READ MORE</a></div>
            </div>
          </div>
        </div>
         ...
         <div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              ...
              <span class="card-title"><div class="re">ROBOSUMO</div></span>
            </div>
            <div class="card-content hide">
              <p>I am a very simple card. I am good at containing small bits of information.
              I am convenient because I require little markup to use effectively.</p>
            ...
            <div class="card-action">
              <div class="se"><a href="robosumo.php" style="color:black">READ MORE</a></div>
            </div>
          </div>
        </div>
         ...
         <div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              <img class="img" src="images/web/Monster.jpg">
              <span class="card-title"><div class="re">Monster Arena</div></span>
            </div>
            <div class="card-content hide">
              <p>I am a very simple card. I am good at containing small bits of information.
              I am convenient because I require little markup to use effectively.</p>
            ...
            <div class="card-action">
              <div class="se"><a href="monsterarena.php" style="color:black">READ MORE</a></div>
            </div>
          </div>
        </div>
...
<div class="row">
 <div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              <img class="img" src="images/web/Walle.jpg">
              <span class="card-title"><div class="re" >Wall-E</div></span>
            </div>
            <div class="card-content hide">
              <p>I am a very simple card. I am good at containing small bits of information.
              I am convenient because I require little markup to use effectively.</p>
            ...
            <div class="card-action">
              <div class="se"><a href="wall-e.php" style="color:black">READ MORE</a></div>
            </div>
          </div>
        </div>
