...
<div class="container">
   ...
   <div class="parallax-container">
    ...
    <div class="row">
      <h1><div id="event_title">VRC</h1>
        <div style="overflow:auto;-webkit-overflow-scrolling:touch">
          <ul class="nav nav-tabs">
              <li class="active"><a data-toggle="tab" href="#theme">Theme</a></li>
              <li><a data-toggle="tab" href="#arena">Arena & Gameplay</a></li>
...
<li>Assault Zone (A.Z )</li>
        ...
        <img src="fun_bg.jpg" class="img-responsive"><center><b>Figure 1</b></center><br>

        <img src="fun_bg.jpg" class="img-responsive"><center><b>Figure 2</b></center><br>

        <img src="fun_bg.jpg" class="img-responsive"><center><b>Figure 3</b></center><br>

        <img src="fun_bg.jpg" class="img-responsive"><center><b>Figure 4</b></center><br>

        <img src="fun_bg.jpg" class="img-responsive"><center><b>Figure 5</b></center><br>

        <img src="fun_bg.jpg" class="img-responsive"><center><b>Figure 6</b></center><br>

        <img src="fun_bg.jpg" class="img-responsive"><center><b>Figure 7</b></center><br>

        <img src="fun_bg.jpg" class="img-responsive"><center><b>Figure 8</b></center><br>
...
The ammunition has to be placed on the navy bot to have access to it
   ...
   There was a chance created virtually every over in the first hour of play. Ishant Sharma was on a hat-trick and Mohammed Shami was bowling what looked like 140kph legbreaks. Making contact with a ball that was swinging and seaming - in both directions - and gaining the benefit of spongy bounce off a damp pitch reminded everyone why batsmen only average 25.44 in Kingston since 1996.

Jermaine Blackwood walked out at No. 5 in the sixth over. West Indies hadn't seen such dire times against India since the Port-of-Spain Test in 1983. He is in the middle of dire times himself, having bagged a second pair in five Tests and was a prime candidate to be dropp.<br>
