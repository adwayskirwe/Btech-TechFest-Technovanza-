        ...
        <div class="col l4 m4 s6 offset-l1 offset-m1">
          ...
          <div class="card hoverable">
            <div class="card-image">
              <div class="imgWrap">
              <img class="img" src="images/web/fast-and-furious-wallpaper-7914564.jpg" >
              <div class="ri"><p class="imgDescription "><br><br>
                    <b>PRIZE : RS 20,000</b>
                    
              </p></div>
              </div>
              <span class="card-title"><div class="re">Fast N Furious</div></span>
            </div>
         ...
         <div class="col l4 m4 s6 offset-l1 offset-m1">
          ...
          <div class="card hoverable">
            <div class="card-image">
              <img class="img" src="images/web/Climb e rope.jpg">
              <span class="card-title"><div class="re">Climb E Rope</div></span>
            </div>
            <div class="card-content hide">
              <p>I am a very simple card. I am good at containing small bits of information.
              I am convenient because I require little markup to use effectively.</p>
