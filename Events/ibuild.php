    ...
    <div class="row">
        <div class="col l4 m4 s6">
         ...
         <div class="col l4 m4 s6">
          ...
          <div class="card hoverable">
            ...
            <div class="card-action">
              <div class="se"><a href="robomaze.php">READ MORE</a></div>
            </div>
          </div>
        </div>
        ...
        <div class="col l4 m4 s6">
          ...
          <div class="card hoverable">
            ...
            <div class="card-action">
              <div class="se"><a href="robosoccer.php">READ MORE</a></div>
            </div>
          </div>
        </div>
         ...
         <div class="col l4 m4 s6">
          ...
          <div class="card hoverable">
            ...
            <div class="card-action">
              <div class="se"><a href="robosumo.php">READ MORE</a></div>
            </div>
          </div>
        </div>
         ...
         <div class="col l4 m4 s6">
          ...
          <div class="card hoverable">
            ...
            <div class="card-action">
              <div class="se"><a href="wall-e.php">READ MORE</a></div>
            </div>
          </div>
        </div>
