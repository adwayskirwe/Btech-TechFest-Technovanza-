...
<title>OnlineEvents|Technovanza</title>
      <style>
        ...
        <div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              ...
              <span class="card-title"><div class="re">Code In X</div></span>
            </div>
            ...
            <div class="card-action">
              <div class="se"><a href="codeinx.php">READ MORE</a></div>
            </div>
          </div>
        </div>
         ...
         <div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              <img class="img" src="fun_bg.jpg">
              <span class="card-title"><div class="re">AI Wars</div></span>
            </div>
            <div class="card-content hide">
              <p>I am a very simple card. I am good at containing small bits of information.
              I am convenient because I require little markup to use effectively.</p>
            ...
            <div class="card-action">
              <div class="se"><a href="aiwars.php">READ MORE</a></div>
            </div>
          </div>
        </div>
         ...
         <div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              <img class="img" src="fun_bg.jpg">
              <span class="card-title"><div class="re">VSM</div></span>
            </div>
            <div class="card-content hide">
              <p>I am a very simple card. I am good at containing small bits of information.
              I am convenient because I require little markup to use effectively.</p>
            ...
            <div class="card-action">
              <div class="se"><a href="vsm.php">READ MORE</a></div>
            </div>
          </div>
        </div>
...
<div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              ...
              <span class="card-title"><div class="re">ALGOCRACK</div></span>
            </div>
            <div class="card-content hide">
              <p>I am a very simple card. I am good at containing small bits of information.
              I am convenient because I require little markup to use effectively.</p>
            ...
            <div class="card-action">
              <div class="se"><a href="algocrack.php">READ MORE</a></div>
            </div>
          </div>
        </div>
         ...
         <div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              <img class="img" src="fun_bg.jpg">
              <span class="card-title"><div class="re">CRYPTEXT</div></span>
            </div>
            <div class="card-content hide">
              <p>I am a very simple card. I am good at containing small bits of information.
              I am convenient because I require little markup to use effectively.</p>
            ...
            <div class="card-action">
              <div class="se"><a href="cryptext.php">READ MORE</a></div>
            </div>
          </div>
        </div>
         ...
         <div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              <img class="img" src="fun_bg.jpg">
              <span class="card-title"><div class="re">MYST</div></span>
            </div>
            <div class="card-content hide">
              <p>I am a very simple card. I am good at containing small bits of information.
              I am convenient because I require little markup to use effectively.</p>
            ...
            <div class="card-action">
              <div class="se"><a href="myst.php">READ MORE</a></div>
            </div>
          </div>
        </div>
