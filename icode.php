...
<title>I Code|Technovanza</title>
      <style>
        ...
        <div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              ...
              <span class="card-title"><div class="re">Ultimate Coder</div></span>
            </div>
            ...
            <div class="card-action">
              <div class="se"><a href="ultimatecoder.php">READ MORE</a></div>
            </div>
          </div>
        </div>
         ...
         <div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              <img class="responsive-img" src="images/web/java.jpg">
              <span class="card-title"><div class="re">Java Guru</div></span>
            </div>
            <div class="card-content hide">
              <p>I am a very simple card. I am good at containing small bits of information.
              I am convenient because I require little markup to use effectively.</p>
            ...
            <div class="card-action">
              <div class="se"><a href="javaguru.php">READ MORE</a></div>
            </div>
          </div>
        </div>
         ...
         <div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              <img class="img" src="fun_bg.jpg">
              <span class="card-title"><div class="re">Mission Sql</div></span>
            </div>
            <div class="card-content hide">
              <p>I am a very simple card. I am good at containing small bits of information.
              I am convenient because I require little markup to use effectively.</p>
            ...
            <div class="card-action">
              <div class="se"><a href="missionsql.php">READ MORE</a></div>
            </div>
          </div>
        </div>
...
<div class="row">
        <div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              <div class="imgWrap">
              <img class="img" src="images/web/Codeswap.jpg" >
              <div class="ri"><p class="imgDescription "><br><br>
                    <b>PRIZE : RS 20,000</b>
                    
              </p></div>
              </div>
              <span class="card-title"><div class="re">Code Swap</div></span>
            </div>
            <div class="card-content hide">
              <p>I am a very simple card. I am good at containing small bits of information.
              I am convenient because I require little markup to use effectively.</p>
            ...
            <div class="card-action">
              <div class="se"><a href="codeswap.php">READ MORE</a></div>
            </div>
          </div>
        </div>
         ...
         <div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              <img class="img" src="fun_bg.jpg">
              <span class="card-title"><div class="re">C way</div></span>
            </div>
            <div class="card-content hide">
              <p>I am a very simple card. I am good at containing small bits of information.
              I am convenient because I require little markup to use effectively.</p>
            ...
            <div class="card-action">
              <div class="se"><a href="c-way.php">READ MORE</a></div>
            </div>
          </div>
        </div>
         ...
         <div class="col l4 m4 s12">
          ...
          <div class="card hoverable">
            <div class="card-image">
              <img class="img" src="fun_bg.jpg">
              <span class="card-title"><div class="re">Technohunt</div></span>
            </div>
            <div class="card-content hide">
              <p>I am a very simple card. I am good at containing small bits of information.
              I am convenient because I require little markup to use effectively.</p>
            ...
            <div class="card-action">
              <div class="se"><a href="technohunt.php">READ MORE</a></div>
            </div>
          </div>
        </div>
        </div>
